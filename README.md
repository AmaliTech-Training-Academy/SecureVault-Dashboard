...
### Phase 1: The Design System (Figma)
...
* **Requirement:** Your design file must include a dedicated **"Design System" page** that defines:
    * **Typography Scale:** (Headings, Body, Metadata, Monospace).
    * **Color Palette:** Primary, Secondary, Surfaces, Borders, and Semantic colors (Success, Error, Warning).
    * **Spacing Grid:** Define your base unit (e.g., 4px or 8px).
    * **Component States:** Show how a file row looks in `Default`, `Hover`, `Selected`, and `Focused` states.
...
* **Task:** Identify a gap in the requirements. What is missing? Is it a "Breadcrumb" bar? A "Right-click context menu"? A "Favorites" pin system? A "File Type Icon" generator?
